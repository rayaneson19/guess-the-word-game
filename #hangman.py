...
name = input('')
print(' \n  \n  \n  \n ')
msg = """Hi """ + name + """. Lets play Hangman, but first we have to explain the game and its instructions so follow me:
...
try:
    while (win) and guesses != g_limit:
        ...
        if user_inp == list(s_word):
                ...
                print(*v, sep="   ")
                print(' \n  \n  \n ')
                winn = ('➡  Exellent job. You guessed my word right!')  
                m(winn)
                win = False 
